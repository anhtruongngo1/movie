...
const MovieTheaters = () => {
    ...
    return ( 
        ...
        onChange={(e)=>valueParent.setSearchKey2(e.target.value)}
        />
       ...
       <h1 className="text-[#F1B722] text-[45px] font-semibold font-Nunito">PHIM CHIẾU RẠP</h1>
       {
